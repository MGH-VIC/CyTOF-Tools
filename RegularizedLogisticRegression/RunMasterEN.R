...
source("MasterEN.R")
#Import data to test
dat = openxlsx::read.xlsx("ALS-Live-cells-k40-elbow-point_SPADEVizR-relative-abundance.xlsx")

#Enter the name of your data file (If multiple files, use: list("File1name.xlsx","File2name.xlsx"))
filename = "ALS-Live-cells-k40-elbow-point_SPADEVizR-relative-abundance.xlsx"
...
top_n = 20
#Set sampling type for class imbalanaces
sampling = NULL
